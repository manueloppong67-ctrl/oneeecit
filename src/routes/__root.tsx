...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MODERN STATE RP" },
      { name: "description", content: "Modern State Rp — multiplayer open-world roleplay community with staff management and player reporting." },
      { name: "author", content: "Modern State Rp" },
      { property: "og:title", content: "MODERN STATE RP" },
      { property: "og:description", content: "Modern State Rp — multiplayer open-world roleplay community." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MODERN STATE RP" },
      { name: "twitter:description", content: "Modern State Rp — multiplayer open-world roleplay community." },
